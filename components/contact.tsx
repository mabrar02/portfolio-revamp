...
export default function Contact() {
  ...
  return (
    ...
    >
        ...
        <form className='mt-10 flex flex-col' method='POST' action="https://getform.io/f/paqxxorb">
            <input name='userEmail' placeholder='Your email' className="h-14 px-4 rounded-lg border border-black/10" type='email' 
            required
            maxLength={500}/>
            <textarea name='userMsg' placeholder="Your message" className='h-52 my-3 rounded-lg border border-black/10 p-4' required maxLength={500}/>
